...
export function FirstRunKeyPrompt({ isDark, onToggleTheme, onSaved }: {
  isDark: boolean;
  onToggleTheme: () => void;
  onSaved: (resumePrompt?: string) => void;
}) {
          ...
          <div className="p-6">
            ...
            {step === 'key' ? (
              <div className="mt-6 space-y-6">
                <div>
                  <h1 className="text-2xl font-bold tracking-tight">Настройте API</h1>
              ...
              <div className="mt-6 space-y-6">
                <div>
                  <h1 className="text-2xl font-bold tracking-tight">Ключ сохранён</h1>
                  <p className="mt-2 text-sm leading-relaxed text-muted-foreground">
